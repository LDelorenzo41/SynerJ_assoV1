...
export const STATUS_COLORS = {
  equipment: {
    available: 'bg-ds-success-soft text-ds-success border-ds-success',
    maintenance: 'bg-ds-warning-soft text-ds-warning border-ds-warning',
    broken: 'bg-ds-danger-soft text-ds-danger border-ds-danger',
  },
  request: {
    pending: 'bg-ds-warning-soft text-ds-warning border-ds-warning',
    approved: 'bg-ds-success-soft text-ds-success border-ds-success',
    rejected: 'bg-ds-danger-soft text-ds-danger border-ds-danger',
    partially_approved: 'bg-terracotta-soft text-terracotta-deep border-terracotta', // ✅ Nouveau
  },
  availability: { // ✅ Nouvelles couleurs pour la disponibilité
    available: 'bg-ds-success-soft text-ds-success border-ds-success',
    partially_available: 'bg-ds-warning-soft text-ds-warning border-ds-warning',
    unavailable: 'bg-ds-danger-soft text-ds-danger border-ds-danger',
    conflicted: 'bg-ds-warning-soft text-ds-warning border-ds-warning',
    equipment_issue: 'bg-papier-2 text-encre border-[var(--ds-border)]',
  },
} as const;
