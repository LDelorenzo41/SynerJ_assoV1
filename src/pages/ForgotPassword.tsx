        ...
        <div className="max-w-md w-full mx-4">
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-encre">Mot de passe oublié</h1>
            ...
            {success ? (
              <div className="space-y-4">
                <div className="bg-ds-success-soft text-ds-success p-4 rounded-lg text-sm">
                ...
                <Link
                  to="/login"
                  className="flex items-center justify-center gap-2 w-full py-3 px-6 bg-terracotta text-white rounded-lg hover:bg-terracotta-deep transition-colors font-medium"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center">
                  <Link 
                    to="/login" 
                    className="text-encre-2 hover:text-terracotta text-sm flex items-center justify-center gap-1"
                  >
                    <ArrowLeft className="h-4 w-4" />
                    Retour à la connexion
                  </Link>
