...
const AcceptInvitation: React.FC = () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-papier-2 rounded-lg shadow-xl p-8 max-w-md w-full">
          <div className="flex items-center justify-center py-8">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-terracotta dark:border-terracotta"></div>
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-papier-2 rounded-lg shadow-xl p-8 max-w-md w-full">
          <div className="text-center mb-6">
            <Mail className="w-16 h-16 text-terracotta dark:text-terracotta mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-encre dark:text-white mb-2">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-700 rounded-lg p-6 mb-6">
            <h3 className="font-semibold text-encre dark:text-white mb-2">
            ...
            {invitation.personal_message && (
              <div className="mt-4 pt-4 border-t border-[var(--ds-border)] dark:border-[var(--ds-border-2)]">
                <p className="text-sm text-encre-2 dark:text-encre-3 italic">
                  "{invitation.personal_message}"
                </p>
              </div>
            )}
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full px-6 py-3 bg-terracotta text-white rounded-lg hover:bg-terracotta-deep transition-colors flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="w-full px-6 py-3 border border-terracotta text-terracotta dark:text-terracotta rounded-lg hover:bg-terracotta-soft dark:hover:bg-terracotta-soft transition-colors flex items-center justify-center gap-2"
            >
  ...
  Connecté en tant que <strong>{user?.email}</strong>
        ...
        {acceptError && (
          <div className="mb-6 p-4 bg-ds-danger-soft dark:bg-ds-danger-soft border border-ds-danger dark:border-ds-danger rounded-lg flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-ds-danger dark:text-ds-danger">{acceptError}</p>
            </div>
          </div>
        )}
        ...
        <button
          ...
          disabled={accepting}
          className="w-full px-6 py-3 bg-terracotta text-white rounded-lg hover:bg-terracotta-deep disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
        >
          {accepting ? (
            <>
